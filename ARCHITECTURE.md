...
Added this pass: a confidence score (`AgentRunResult.confidence`) from real run events status, synthesis attempt count, whether a proven precedent matched  with a reason
